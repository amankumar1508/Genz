  ...
  return (
    ...
    <div className='w-full py-40'>
        ...
        <div className='container mx-auto '>
            ...
            <p className='text-center font-semibold text-xl mx-w-xl mx-auto px-2 mb-12' >At our agency, we take pride that deliver the projects that have creativity, strategy, and tec</p>

            {/* Button */}
            <div className='flex items-center justify-center gap-6'>
                <button className='font-semibold bg-amber-500 px-4 py-3 rounded-full'>
                    Contact Us
                </button>
              ...
              {/* hero image*/}
              <div className=" mt-12 mx-auto max-w-xl border-2  ">
